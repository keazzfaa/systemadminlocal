...
import { Search, Download, Plus, Edit2, Trash2, X, Save, Store, Package, CheckCircle, AlertTriangle, XCircle } from "lucide-react";
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            {filtered.map(x => {
                                ...
                                const status = getStockStatus(x.stok);
                        ...
                        <div className="modal-body">
                            <div className="form-grid2">
                                <div className="form-group">
                                    <label>Sales</label>
                                    <select className="field"  value={form.sales} onChange={e => setForm(p => ({ ...p, sales: e.target.value }))}>
                                ...
                                <div className="form-group">
                                    <label>Area</label>
                                    <select className="field"  value={form.area} onChange={e => setForm(p => ({ ...p, area: e.target.value }))}>
