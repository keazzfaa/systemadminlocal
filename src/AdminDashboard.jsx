  ...
  return (
    <>
      ...
      <section className="stat-grid">
        {[
            ["Barang Masuk", itemsIn.length, "Aktif", Package, "blue", "/barang-masuk"],
            ["Barang Keluar", itemsOut.length, "Aktif", Package, "green", "/barang-keluar"],
            ["Supplier", suppliers.length, "Aktif", Users, "blue", "/supplier"],
            ["Customer", customers.length, "Aktif", Users, "blue", "/customer"],
            ["Cash Masuk", FMT(totalMasuk), "+", Wallet, "green", "/cashflow"],
            ["Cash Keluar", FMT(totalKeluar), "-", CreditCard, "red", "/cashflow"],
